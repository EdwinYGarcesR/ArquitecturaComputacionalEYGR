...
void secuencial_Efecto1(void) {
    for (int i = 0; i < 8; i++) {
        LATD = 1 << i;
        if(velocidad==1){_delay((unsigned long)((50)*(800000/4000.0)));}
        else if(velocidad==2){_delay((unsigned long)((100)*(800000/4000.0)));}
        else if(velocidad==3){_delay((unsigned long)((200)*(800000/4000.0)));}
        else if(velocidad==4){_delay((unsigned long)((400)*(800000/4000.0)));}

        if (!PORTBbits.RB6) {
            _delay((unsigned long)((50)*(800000/4000.0)));
